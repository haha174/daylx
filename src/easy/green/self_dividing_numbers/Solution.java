package easy.green.self_dividing_numbers;
...
//    }
    ...
    public static void main(String[] args) {
        System.out.println(new Solution().selfDividingNumbers(1, 10000));
    }
}